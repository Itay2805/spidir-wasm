...
typedef enum jit_helper_kind {
    ...
    JIT_HELPER_MEMORY_INIT,

    JIT_HELPER_F32_ABS,
    JIT_HELPER_F32_NEG,
    JIT_HELPER_F32_CEIL,
    JIT_HELPER_F32_FLOOR,
    JIT_HELPER_F32_TRUNC,
    JIT_HELPER_F32_NEAREST,
    JIT_HELPER_F32_SQRT,

    JIT_HELPER_F32_MIN,
    JIT_HELPER_F32_MAX,
    JIT_HELPER_F32_COPYSIGN,

    JIT_HELPER_F64_ABS,
    JIT_HELPER_F64_NEG,
    JIT_HELPER_F64_CEIL,
    JIT_HELPER_F64_FLOOR,
    JIT_HELPER_F64_TRUNC,
    JIT_HELPER_F64_NEAREST,
    JIT_HELPER_F64_SQRT,

    JIT_HELPER_F64_MIN,
    JIT_HELPER_F64_MAX,
    JIT_HELPER_F64_COPYSIGN,

    JIT_HELPER_I32_TRUNC_SAT_F32_S,
    JIT_HELPER_I32_TRUNC_SAT_F32_U,
    JIT_HELPER_I32_TRUNC_SAT_F64_S,
    JIT_HELPER_I32_TRUNC_SAT_F64_U,
    JIT_HELPER_I64_TRUNC_SAT_F32_S,
    JIT_HELPER_I64_TRUNC_SAT_F32_U,
    JIT_HELPER_I64_TRUNC_SAT_F64_S,
    JIT_HELPER_I64_TRUNC_SAT_F64_U,
